...
from gen import generate_hex_grid
from gen import HexMinesweeper

class GameWindow(tk.Tk):
	def __init__(self):
		super().__init__()
		self.title("MINESWEEPER ULTRA")
		...
		## ==============================
		## MARK: SIDE PANEL
		self.side_panel_title = tk.Label(self.side_panel, text=" ")
		...
		## ==============================
		## MARK: Main PANEL
		self.main_panel_title = tk.Label(self.main_panel, text="< Hex Grid >")
